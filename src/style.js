const styles = {
    ...
    heading4: "font-poppins font-semibold xs:text-[40px] text-[30px] text-back xs:leading-[76.8px] leading-[40px] w-full",
    ...
    paddingX2: "sm:px-8 px-4",
    paddingY2: "sm:py-6 py-4",
