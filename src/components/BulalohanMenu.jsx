...
const Bulalohan = () => (
    <section className={`${styles.marginX} ${styles.marginY} `}>
        <h1 className={`${styles.heading3}`}>Bulalohan sa Riyadh Menu</h1>
        <div className={`${styles.paddingY2} ${styles.paddingX2} mt-10 bg-orange rounded-xl rounded-b-none`}>
          <h1 className={`font-poppins font-semibold text-[24px] text-white`}>BREAKFAST</h1>
        </div>
